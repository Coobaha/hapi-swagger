    ...
    return {
        ...
        handler: function (request, reply) {
            ...
            var routes = request.server.table()[0].table,
                ...
                internals.joiDescription = request.query.joi;
...
internals.validatorsToProperties = function (params, models, requiredArray) {
    ...
    if (Array.isArray(params)) {
        ...
        while (x < i) {
            ...
            properties[key] = internals.validatorToProperty(key, param, models, requiredArray, internals.joiDescription);
            x++;
        }
    }
...
internals.validatorToProperty = function (name, param, models, requiredArray, joiDescribe) {
    if (param === null ||
        param === undefined) {
        return undefined;
    }
    ...
    if (param.describe) {
        ...
        if (joiDescribe) {
          ...
          property.description =
            typeof param._description === 'string' ? param._description : undefined;
          property.notes =
            typeof param._notes !== 'function' && param._notes.length ? param._notes : undefined;
          property.tags =
            typeof param._tags !== 'function' && param._tags.length ? param._tags : undefined;
          ...
          if (property.type === 'array') {
            ...
            var arrayTypes = param._inner ? param._inner.inclusions :
              internals.getArgByName(describe.rules, 'includes');
            ...
            if (firstInclusionType) {
              ...
              if (name === 'items' &&
                Hoek.reach(param, '_inner.inclusions.0._settings.className')) {
